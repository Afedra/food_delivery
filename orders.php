            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#"  class="waves-effect waves-block waves-light"><b>Ugx <?php echo $balance;?></b></a>
                        </li>
                    </ul>						
                </div>
            </nav>
...
<div id="work-collections" class="seaction">
							...
							$id = $row1['order_id'];
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>Ugx. '.$row['total'].'</strong></span>
                                            </div>';
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2018 <a class="grey-text text-lighten-4" href="#" target="_blank">Martne Inc</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Martne Inc</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
